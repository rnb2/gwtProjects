...
public interface ManageServiceAsync {
	...
	/**
	 *  опирование пользовател€
	 * @param userNameNew - новое им€ пользовател€
	 * @param fio - ‘»ќ
	 * @param phone - 
	 * @param employeeId - таб є
	 * @param userNameOld - старое им€ пользовател€
	 * @param serverName - сервер, на котором осущ. копирование  
	 * @param userNameCreated - пользователь выполн€ющий операцию
	 * @param callback
	 */
