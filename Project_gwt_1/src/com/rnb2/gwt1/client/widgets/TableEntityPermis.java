...
/**
 * Справочники доступн. пользователю
 * @author budukh-rn
 *
 */
public class TableEntityPermis implements IsWidget {
	...
	/**
	 * Удаление доступа к справочникам ИДС УЖДТ
	 * @return
	 */
	...
	/**
	 * Удаение доступа к справочникам ИДС УЖДТ
	 * @return
	 */
	...
	/**
	 * Добавление доступа к справочникам ИДС УЖДТ
	 * @return
	 */
